...
const MOCK_STOCKS: StockVal[] = [
  { symbol: 'AAPL', name: 'Apple Inc.', price: 234.56, pct: 1.24, marketCap: '$3.58T', pe: 31.2, forwardPE: 28.5, pegRatio: 2.1, pb: 48.2, ps: 8.9, evEbitda: 26.1, debtEquity: 1.73, roe: 157.4, revenueGrowth: 6.2, earningsGrowth: 10.8, dcfTarget: 258.00, analystTarget: 245.50, upside: 10.0, rating: 'Overweight' },
  { symbol: 'MSFT', name: 'Microsoft', price: 445.12, pct: 0.89, marketCap: '$3.31T', pe: 35.8, forwardPE: 32.1, pegRatio: 2.4, pb: 12.8, ps: 13.6, evEbitda: 27.8, debtEquity: 0.42, roe: 38.5, revenueGrowth: 16.4, earningsGrowth: 21.2, dcfTarget: 492.00, analystTarget: 480.00, upside: 10.5, rating: 'Buy' },
  { symbol: 'NVDA', name: 'NVIDIA', price: 892.45, pct: 2.31, marketCap: '$2.21T', pe: 65.2, forwardPE: 38.2, pegRatio: 1.2, pb: 58.4, ps: 37.2, evEbitda: 55.1, debtEquity: 0.41, roe: 115.8, revenueGrowth: 122.4, earningsGrowth: 168.5, dcfTarget: 1050.00, analystTarget: 980.00, upside: 17.7, rating: 'Strong Buy' },
  { symbol: 'GOOGL', name: 'Alphabet', price: 178.90, pct: -0.32, marketCap: '$2.21T', pe: 22.4, forwardPE: 19.8, pegRatio: 1.1, pb: 7.2, ps: 7.5, evEbitda: 16.2, debtEquity: 0.10, roe: 30.1, revenueGrowth: 14.8, earningsGrowth: 28.4, dcfTarget: 210.00, analystTarget: 198.00, upside: 17.4, rating: 'Buy' },
  { symbol: 'META', name: 'Meta', price: 612.45, pct: 1.78, marketCap: '$1.55T', pe: 28.9, forwardPE: 23.4, pegRatio: 1.0, pb: 9.6, ps: 11.2, evEbitda: 19.8, debtEquity: 0.35, roe: 33.2, revenueGrowth: 24.1, earningsGrowth: 35.8, dcfTarget: 720.00, analystTarget: 660.00, upside: 17.6, rating: 'Strong Buy' },
  { symbol: 'AMZN', name: 'Amazon', price: 198.34, pct: 0.67, marketCap: '$2.06T', pe: 62.1, forwardPE: 38.5, pegRatio: 1.8, pb: 8.4, ps: 3.4, evEbitda: 22.1, debtEquity: 0.58, roe: 22.8, revenueGrowth: 12.5, earningsGrowth: 42.1, dcfTarget: 230.00, analystTarget: 218.00, upside: 16.0, rating: 'Buy' },
];
